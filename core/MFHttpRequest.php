...
class MFHttpRequest
{
    ...
    /**
     * @var string the name of the token used to prevent CSRF. Defaults to 'MF_CSRF_TOKEN'.
     * This property is effectively only when {@link enableCsrfValidation} is true.
     */
    public $csrfTokenName='MF_CSRF_TOKEN';
    ...
    protected function normalizeRequest()
    {
        ...
        //if($this->enableCsrfValidation)
            //MF::app()->attachEventHandler('onBeginRequest',array($this,'validateCsrfToken'));
    }
    ...
    public function getScriptUrl()
    {
        if($this->_scriptUrl===null)
        {
            ...
            elseif(isset($_SERVER['DOCUMENT_ROOT']) && strpos($_SERVER['SCRIPT_FILENAME'],$_SERVER['DOCUMENT_ROOT'])===0)
                ...
                throw new Exception(MF::t('core','MFHttpRequest is unable to determine the entry script URL.'));
        }
    ...
    public function getPathInfo()
    {
        if($this->_pathInfo===null)
        {
            ...
            $pathInfo=substr($_SERVER['PHP_SELF'],strlen($scriptUrl));
                ...
                throw new Exception(MF::t('core','MFHttpRequest is unable to determine the path info of the request.'));
    ...
    public function getRequestUri()
    {
        if($this->_requestUri===null)
        {
            ...
            elseif(isset($_SERVER['ORIG_PATH_INFO']))  // IIS 5.0 CGI
            {
                ...
                throw new Exception(MF::t('core','MFHttpRequest is unable to determine the request URI.'));
        }
    ...
    public function getCookies()
    {
        if($this->_cookies!==null)
            ...
            return $this->_cookies=new MFCookieJar($this);
    }
    ...
    public function getPreferredLanguage()
    {
        ...
        return !empty($preferredLanguages) ? MFLocale::getCanonicalID($preferredLanguages[0]) : false;
    }
    ...
    public function sendFile($fileName,$content,$mimeType=null,$terminate=true)
    {
        if($mimeType===null)
        {
            if(($mimeType=MFFileHelper::getMimeTypeByExtension($fileName))===null)
                $mimeType='text/plain';
        }
        ...
        if(isset($_SERVER['HTTP_RANGE']))
        {
            ...
            if(strpos($_SERVER['HTTP_RANGE'],',')!==false)
            {
                ...
                throw new MFHttpException(416,'Requested Range Not Satisfiable');
            }
     ...
     * <pre>
     * <?php
     *    MF::app()->httpRequest->xSendFile('/home/user/Pictures/picture1.jpg',array(
     *        'saveName'=>'image1.jpg',
     *        'mimeType'=>'image/jpeg',
     *        'terminate'=>false,
     *    ));
    ...
    public function xSendFile($filePath, $options=array())
    {
        ...
        {
            if(($options['mimeType']=MFFileHelper::getMimeTypeByExtension($filePath))===null)
     ...
     * @throws MFHttpException if the validation fails
     */
    public function validateCsrfToken()
    {
            ...
            $this->getIsDeleteRequest())
        {
            ...
            if (!empty($userToken) && $cookies->contains($this->csrfTokenName))
            {
                ...
                $valid = false;
            if (!$valid)
                throw new MFHttpException(400,MF::t('core','The CSRF token could not be verified.'));
        }
    }
}