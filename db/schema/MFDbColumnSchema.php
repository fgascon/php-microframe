...
/**
 * MFDbColumnSchema class describes the column meta data of a database table.
 *
 * @author Qiang Xue <qiang.xue@gmail.com>
...
class MFDbColumnSchema extends MFComponent
{
	...
	{
		if(gettype($value)===$this->type || $value===null || $value instanceof MFDbExpression)
			return $value;
