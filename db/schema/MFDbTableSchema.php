...
/**
 * MFDbTableSchema is the base class for representing the metadata of a database table.
 *
 * It may be extended by different DBMS driver to provide DBMS-specific table metadata.
 *
 * MFDbTableSchema provides the following information about a table:
 * <ul>
 * <li>{@link name}</li>
 * <li>{@link rawName}</li>
 * <li>{@link columns}</li>
...
class MFDbTableSchema extends MFComponent
{
	...
	/**
	 * @var array column metadata of this table. Each array element is a MFDbColumnSchema object, indexed by column names.
	 */
	 ...
	 * @return MFDbColumnSchema metadata of the named column. Null if the named column does not exist.
	 */
