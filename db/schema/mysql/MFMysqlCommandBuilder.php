<?php
/**
 * MFMysqlCommandBuilder class file.
 *
...
/**
 * MFMysqlCommandBuilder provides basic methods to create query commands for tables.
 *
 * @author Carsten Brandt <mail@cebe.cc>
 * @package system.db.schema.mysql
 * @since 1.1.13
 */
class MFMysqlCommandBuilder extends MFDbCommandBuilder
{
	/**
