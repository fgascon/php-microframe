...
/**
 * MFDbCriteria represents a query criteria, such as conditions, ordering by, limit/offset.
 *
...
class MFDbCriteria extends CComponent
{
	 ...
	 * @param mixed $criteria the criteria to be merged with. Either an array or MFDbCriteria.
