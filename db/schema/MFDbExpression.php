...
/**
 * MFDbExpression represents a DB expression that does not need escaping.
 * MFDbExpression is mainly used in {@link CActiveRecord} as attribute values.
 * When inserting or updating a {@link CActiveRecord}, attribute values of
 * type MFDbExpression will be directly put into the corresponding SQL statement
